...
class _ChatHomeState extends State<ChatHome>
  ...
  Widget build(BuildContext context) {
    ...
    return User(id: id, username: username, nativelang: nativelang,  phoneNumber: phoneNumber);
  }
  ...
  void initUser() async {
    if(await isRegistered) {
      ...
      db.createThisUser(username, password, myLocale.languageCode, phoneNumber);
